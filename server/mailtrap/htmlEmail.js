            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to FlavorHaven!</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at FlavorHaven. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The FlavorHaven Team</p>
                </div>
                <div class="email-footer">
                  <p>&copy; 2024 FlavorHaven. All rights reserved.</p>
                </div>
              </div>
            </body>
          </html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The FlavorHaven Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 FlavorHaven. All rights reserved.</p>
            </div>
